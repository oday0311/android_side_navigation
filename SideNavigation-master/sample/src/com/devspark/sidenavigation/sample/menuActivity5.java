 ...
 */
public class menuActivity5 extends SherlockActivity implements ISideNavigationCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menuactivity5);
...
//                break;
    ...
    public void httpTest()
    {
        ...
        try{
            ...
            String responseString = getResultForHttpGet("");
    ...
    public String getResultForHttpGet(String phoneNum) throws ClientProtocolException,  IOException {
        ...
        ///http://easynote.sinaapp.com/birthday/getcontent.php?day=529
        WebView webview;
        webview = (WebView)findViewById(R.id.webView);


        webview.loadUrl("http://easynote.sinaapp.com/birthday/getcontent.php?day=529");

        //webview.findAllAsync("您当前的位置");
